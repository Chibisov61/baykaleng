...
explicit uk5_b_var(std::string n, const std::string& t, const std::string& def="0.", int max = 0, std::pair<double, double> delta = { 1.,1. }, std::pair<double, double> shift = { 0.,0. }, int c = 8);	//	конструктор (пользовательский) 
