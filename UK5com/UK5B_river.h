...
public:
	...
	UK5B_river() = default;
	static				double	UK5B_eval_dog(double,UK5B_varD);						//pi qst
	static				double	UK5B_eval_nn(double,UK5B_varD,UK5B_varD,UK5B_varD);		//pi vr dog qst
	static				double	UK5B_eval_xn(double,UK5B_varD,UK5B_varD,UK5B_varD);		//pi vr dog qst
	static				double	UK5B_eval_pc(double,UK5B_varD,UK5B_varD);				//g h psh
	static				double	UK5B_eval_pd(double,UK5B_varD,UK5B_varD,UK5B_varD);		//g vr h pc
